...
namespace FF1PRAP
{
	class Scripts
	{
		...
		public static List<string> TempleOfFiends = new()
		{
			...
			"PrincessSaved:",
			"Nop",
			$"Branch ScenarioFlag1 {(int)ScenarioFlags.BlackOrbReqCompleted} [BlackOrbsReqCompleted]",
			"SetEntities ev_e_0014",
			"Exit",
			"BlackOrbsReqCompleted:",
			"Nop",
		...
		public static List<string> Bahamut = new()
		{
			...
			$"Branch TreasureFlag1 {(int)TreasureFlags.Bahamut} [BahamutJobGiven]",
			$"Branch ScenarioFlag1 {(int)ScenarioFlags.RatTail} [BahamutJobTail]",
			"BahamutJobGiven:",
			"Nop",
		...
		public static List<string> LuteSlab = new()
		{
			"Sub Main:",
			"Nop",
			$"Branch ScenarioFlag1 {(int)ScenarioFlags.LuteAccessCompleted} [HasLute]",
			"Msg MSG_LUTESLAB",
			"Exit",
			"HasLute:",
			"Nop",
